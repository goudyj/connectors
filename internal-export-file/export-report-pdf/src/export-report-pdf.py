...
class ExportReportPdf:
    ...
    def _process_message(self, data):
        ...
        if entity_type == "Report":
            self._process_report(entity_id, file_name, file_max_markings)
        elif entity_type == "Case-Incident":
            self._process_case(entity_id, file_name, entity_type, file_max_markings)
        elif entity_type == "Case-Rfi":
            self._process_case(entity_id, file_name, entity_type, file_max_markings)
        elif entity_type == "Case-Rft":
            self._process_case(entity_id, file_name, entity_type, file_max_markings)
        elif entity_type == "Intrusion-Set":
            self._process_intrusion_set(entity_id, file_name, file_max_markings)
        elif entity_type == "Threat-Actor-Group":
            self._process_threat_actor_group(entity_id, file_name, file_max_markings)
        elif entity_type == "Threat-Actor-Individual":
            self._process_threat_actor_individual(entity_id, file_name, file_max_markings)
        else:
            raise ValueError(
    ...
    def _process_report(self, entity_id, file_name, file_max_markings):
        """
        ...
        self.helper.api.stix_domain_object.push_entity_export(
            report_id, file_name, pdf_contents, file_max_markings, "application/pdf"
        )

    def _process_intrusion_set(self, entity_id, file_name, file_max_markings):
        """
        ...
        self.helper.log_info(f"Uploading: {file_name}")
        self.helper.api.stix_domain_object.push_entity_export(
            entity_id, file_name, pdf_contents, file_max_markings, "application/pdf"
        )

    def _process_threat_actor_group(self, entity_id, file_name, file_max_markings):
        """
    ...
    def _process_threat_actor_individual(self, entity_id, file_name, file_max_markings):
        """
    ...
    def _process_case(self, entity_id, file_name, entity_type, file_max_markings):
        """
